...
//           if (teamScore.totalScore < 0) errors.push(`${teamPrefix}: Total score cannot be negative`);
...
//             teamBonusScore: Math.max(0, bonusScore),
